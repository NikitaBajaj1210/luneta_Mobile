...
class MedicalDocumentProvider extends ChangeNotifier {
  ...
  void resetForm() {
    ...
    drugAndAlcoholTestNeverExpire = null;
    ...
    hasExistingMedicalFitnessDocument = false;
    hasExistingDrugAndAlcoholTestDocument = false;
    hasExistingVaccinationCertificateDocument = false;
    notifyListeners();
  }
  ...
  void _populateFormData() {
    ...
    if (medicalDocumentData?.medicalFitnessDocumentPath != null && medicalDocumentData!.medicalFitnessDocumentPath.isNotEmpty) {
      hasExistingMedicalFitnessDocument = true;
    }
    ...
    if (medicalDocumentData?.drugAlcoholTestDocumentPath != null && medicalDocumentData!.drugAlcoholTestDocumentPath.isNotEmpty) {
      hasExistingDrugAndAlcoholTestDocument = true;
    }
    ...
    if (medicalDocumentData!.vaccinationCertificates!.isNotEmpty) {
      for (var cert in medicalDocumentData!.vaccinationCertificates!) {
        ...
        vaccinationCertificateCertificateNoController.text = cert.certificateNo!;
    ...
    if (medicalDocumentData?.vaccinationCertificateDocumentPath != null && medicalDocumentData!.vaccinationCertificateDocumentPath.isNotEmpty) {
      hasExistingVaccinationCertificateDocument = true;
    }
    notifyListeners();
  }
  // Controllers
  ...
  bool hasExistingMedicalFitnessDocument = false;
  bool hasExistingDrugAndAlcoholTestDocument = false;
  bool hasExistingVaccinationCertificateDocument = false;
