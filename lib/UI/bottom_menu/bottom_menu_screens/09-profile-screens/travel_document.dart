...
class _TravelDocumentScreenState extends State<TravelDocumentScreen> {
  ...
  Future<void> _handleSaveButton(TravelDocumentProvider provider) async {
    ...
    if (provider.formKey.currentState!.validate() && validateAttachment(provider)) {
      ...
      if (success) {
        // WidgetsBinding.instance.addPostFrameCallback((_) {
        Provider.of<ProfileBottommenuProvider>(context, listen: false)
      ...
      builder: (context, provider, child) {
        ...
        return SafeArea(
          child: Container(
            ...
            child: NetworkService.loading == 0
                ? Center(
                    child: CircularProgressIndicator(
                        color: AppColors.Color_607D8B),
                  )
                : NetworkService.loading == 1
                    ? Padding(
                        ...
                        child: Center(
                          child: GestureDetector(
                            onTap: () {
                              ...
                              String userId =
                                  NetworkHelper.loggedInUserId.isNotEmpty
                                      ? NetworkHelper.loggedInUserId
                                      : '';
                              provider.fetchTravelDocuments(userId, context);
                              setState(() {});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      if (provider.seamanIssueDateController
                                          .text.isNotEmpty) {
                                        final String startDateString = provider
                                            .seamanIssueDateController.text;
                                        DateTime firstDate = DateTime(
                                            DateTime.now().year -
                                                100); // default fallback
                                  ...
                                  if (provider.travelDocumentData?.seamansBookDocumentPath.isNotEmpty == true)
                                    GestureDetector(
                                      onTap: (){
                                        OpenFile_View(provider.travelDocumentData?.seamansBookDocumentPath,context);
                                      },
                                      child: Container(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 4.w, vertical: 2.h),
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                setState(() {
                                                  provider.travelDocumentData?.seamansBookDocumentPath = '';
                                                  provider.travelDocumentData?.seamansBookDocumentOriginalName = '';
                                                  provider.hasExistingSeamanDocument = false;
                                                });
                                              },
                                              child: Icon(
                                                Icons.close,
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            ...
                                            if (picked != null) {
                                              provider.setSeafarerVisaIssueDate(
                                                  picked);
                                            }
                                          },
                                          child: AbsorbPointer(
                                        ...
                                        if (provider.travelDocumentData?.seafarerVisaDocumentPath.isNotEmpty == true)
                                          GestureDetector(
                                            onTap: (){
                                              OpenFile_View(provider.travelDocumentData?.seafarerVisaDocumentPath,context);
                                            },
                                            child: Container(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: 4.w, vertical: 2.h),
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        provider.travelDocumentData?.seafarerVisaDocumentPath = '';
                                                        provider.travelDocumentData?.seafarerVisaDocumentOriginalName = '';
                                                        provider.hasExistingSeafarerVisaDocument = false;
                                                      });
                                                    },
                                                    child: Icon(
                                                      Icons.close,
                                  ...
                                  if (provider.travelDocumentData?.visaDocumentPath.isNotEmpty == true)
                                    GestureDetector(
                                      onTap: (){
                                        OpenFile_View(provider.travelDocumentData?.visaDocumentPath,context);
                                      },
                                      child: Container(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 4.w, vertical: 2.h),
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                setState(() {
                                                  provider.travelDocumentData?.visaDocumentPath = '';
                                                  provider.travelDocumentData?.visaDocumentOriginalName = '';
                                                  provider.hasExistingVisaDocument = false;
                                                });
                                              },
                                              child: Icon(
                                                Icons.close,
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      if (picked != null) {
                                        provider.setResidencePermitIssueDate(
                                            picked);
                                      }
                                    },
                                    child: AbsorbPointer(
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      if (provider
                                        ...
                                        if (picked != null) {
                                          provider.setResidencePermitExpiryDate(
                                              picked);
                                        }
                                      } else {
                                        ShowToast("Error",
                                  ...
                                  if (provider.residencePermitDocument ==
                                          null &&
                                      !provider
                                          .hasExistingResidencePermitDocument &&
                                      provider.autovalidateMode ==
                                  ...
                                  if (provider.travelDocumentData?.residencePermitDocumentPath.isNotEmpty == true)
                                    GestureDetector(
                                      onTap: (){
                                        OpenFile_View(provider.travelDocumentData?.residencePermitDocumentPath,context);
                                      },
                                      child: Container(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 4.w, vertical: 2.h),
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                setState(() {
                                                  provider.travelDocumentData?.residencePermitDocumentPath = '';
                                                  provider.travelDocumentData?.residencePermitDocumentOriginalName = '';
                                                  provider.hasExistingResidencePermitDocument = false;
                                                });
                                              },
                                              child: Icon(
                                                Icons.close,
